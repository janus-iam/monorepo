    ...
    <section className="island-shell rounded-2xl p-6 sm:p-8 lg:p-10">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-4">
          ...
          <p className="mt-2 text-sm text-[var(--sea-ink-soft)]">{t("sections.auth.step1")}</p>
        </div>
        <div className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-4">
          <span className="text-xs font-bold text-[var(--kicker)]">2</span>
          <p className="mt-2 text-sm text-[var(--sea-ink-soft)]">{t("sections.auth.step2")}</p>
        </div>
        <div className="rounded-xl border border-[var(--line)] bg-[var(--surface)] p-4 sm:col-span-2 lg:col-span-1">
          ...
          <p className="mt-2 text-sm text-[var(--sea-ink-soft)]">{t("sections.auth.step3")}</p>
        </div>
      </div>
      <ul className="mt-8 flex flex-wrap gap-4 border-t border-[var(--line)] pt-8">
        {points.map((point, i) => (
          <li key={i} className="text-sm font-medium text-[var(--sea-ink)]">
            {point}
          </li>
        ))}
      </ul>
